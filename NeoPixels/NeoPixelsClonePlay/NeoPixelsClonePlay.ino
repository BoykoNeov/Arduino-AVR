...
void setup() {
	...
	RandomAndDarkPixels(50);
	delay(1000);
	RearrangeDarkPixelsSequentally(50);
	RearrangeDarkPixelsSequentallyLightFirst(50);
	delay(1000);
	...
	{
		SequentalRandomChange(5000, 0);
		SequentalRandomChange(5000, 10000);
	}
